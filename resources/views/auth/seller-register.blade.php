                    ...
                    <form method="POST" action="{{ route('register-seller') }}">
                        ...
                        <div class="fw-bold mt-5">
                            <div class="mb-3">
                                ...
                                <input class="w-100 w-lg-75 px-2 py-3 rounded" type="text" name="first_name" id="" placeholder="First Name"
                                    required>
                                @error('first_name')
                            ...
                            <div class="mb-3">
                                <label for="last-name" class="d-block text-uppercase mb-2">Last Name <span class="text-danger font-bold">*</span></label>
                                <input class="w-100 w-lg-75 px-2 py-3 rounded" type="text" name="last_name" id="" placeholder="Last Name"
                                    required>
                                @error('last_name')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            ...
                            <div class="mb-3">
                                <label for="first-name" class="d-block text-uppercase mb-2">Division <span class="text-danger font-bold">*</span></label>
                                <select name="division_id" id="division" class="form-select w-100 w-lg-75 px-2 py-3 rounded border border-black border-2"
