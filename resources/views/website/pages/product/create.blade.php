                    ...
                    <form method="POST" action="{{ route('product.store') }}" id="createProduct" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="old_price" class="form-control" id="price" placeholder="Enter old price"
                                step="0.01" value="{{ old('old_price') ? old('old_price') : '' }}" required />
                            @error('old_price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="number" name="new_price" class="form-control" id="price" placeholder="Enter new price"
                                step="0.01" value="{{ old('new_price') ? old('new_price') : '' }}" required />
                            @error('new_price')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-3">
                            ...
                            <input type="text" name="weight" class="form-control" id="price" placeholder="Enter weight"
                                step="0.01" value="{{ old('weight') ? old('weight') : '' }}" required />
                            @error('weight')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
