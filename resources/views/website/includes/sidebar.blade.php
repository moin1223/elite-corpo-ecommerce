<nav class="sidebar dark_sidebar">
    <div class="logo d-flex justify-content-between">
        <a class="large_logo" href="index.html">
            <img class="ms-5" src="{{ asset('/frontend/images/elit-logo.jpg') }}" alt="Dream-Walkers"
                style="width: 100px; height: auto;">


        </a>
        <a class="small_logo" href="index.html">
            <img src={{ asset('/frontend/images/elit-logo.jpg') }} alt="Dream-Walkers"
    ...
    <ul id="sidebar_menu">
        ...
        @include('website.component.sidebar-component', [
            ...
            'links' => [
                [
                    'title' => 'List',
                    'route' => 'authorized-partner.index',
                    'link' => route('authorized-partner.index'),
                ],
                //  ['title' => 'Check new request', 'route' => 'checkRequest', 'link' => route('checkRequest')],
                [
                    'title' => 'Create',
        ...
        @include('website.component.sidebar-component', [
            ...
            'links' => [
                ...
                [
                    'title' => 'Generate Code',
                    'route' => 'product-code.create',
                    'link' => route('product-code.create'),
                ],
                [
                    'title' => 'Download Code',
                    'route' => 'product-code.generate-pdf',
                    'link' => route('product-code.generate-pdf'),
                ],
            ],
        ...
        @include('website.component.sidebar-component', [
            ...
            'links' => [
                [
                    'title' => 'List',
                    'route' => 'auth-image-video.index',
                    'link' => route('auth-image-video.index'),
                ],
                //  ['title' => 'Check new request', 'route' => 'checkRequest', 'link' => route('checkRequest')],
                [
                    'title' => 'Create',
